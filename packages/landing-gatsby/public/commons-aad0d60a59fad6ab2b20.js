  ...
  [0],
  {
      ...
      (function(t) {
        ...
        var s,
          ...
          b = function(t, e) {
            var n = t.baseTag,
              ...
              f = t.title,
              E = t.titleAttributes;
            g(u.TAG_NAMES.BODY, r), g(u.TAG_NAMES.HTML, o), P(f, E);
            var p = {
                ...
                scriptTags: O(u.TAG_NAMES.SCRIPT, T),
          ...
          P = function(t, e) {
            void 0 !== t && document.title !== t && (document.title = v(t)),
        ...
        (e.convertReactPropstoHtmlAttributes = function(t) {
          ...
          (e.reducePropsToState = function(t) {
            return {
              baseTag: p([u.TAG_PROPERTIES.HREF], t),
              bodyAttributes: E(u.ATTRIBUTE_NAMES.BODY, t),
              defer: A(t, u.HELMET_PROPS.DEFER),
              encode: A(t, u.HELMET_PROPS.ENCODE_SPECIAL_CHARACTERS),
              htmlAttributes: E(u.ATTRIBUTE_NAMES.HTML, t),
              linkTags: d(
                u.TAG_NAMES.LINK,
              ...
              title: l(t),
              titleAttributes: E(u.ATTRIBUTE_NAMES.TITLE, t),
            };
          }),
    ...
    '8LQc': function(t, e, n) {
      ...
      if (
        ...
        for (
          ...
          d(A[y++]);
        (l.constructor = s), (s.prototype = l), n('SWlE')(r, 'RegExp', s);
      }
      n('7sbX')('RegExp');
    },
    F0GY: function(t, e, n) {
    ...
    'ff/Y': function(t) {
      t.exports = JSON.parse(
        '{"data":{"site":{"siteMetadata":{"title":"A react next landing page","description":"Kick off your next, great Gatsby project with this default starter. This barebones starter ships with the main Gatsby configuration files you might need.","author":"@gatsbyjs"}}}}'
      );
    },
    kqzl: function(t, e, n) {
      n('RT/e'),
    ...
    rqe8: function(t, e, n) {
      ...
      n('he6s'), n('OPGF'), n('Qf75'), n('0W7U'), n('KXhL');
      var o = n('ERkP'),
        i = r(o),
        a = r(n('Pu0A'));
      function u(t, e, n) {
    ...
    vrFN: function(t, e, n) {
      ...
      function s(t) {
        ...
        return i.a.createElement(c.StaticQuery, {
          query: T,
          render: function(t) {
            var r = e || t.site.siteMetadata.description;
      ...
      (s.defaultProps = { lang: 'en', meta: [], keywords: [] }), (e.a = s);
      var T = '1025518380';
    },
  },
]);
//# sourceMappingURL=commons-aad0d60a59fad6ab2b20.js.map
